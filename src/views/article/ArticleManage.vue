...
import { articlaCategoryListService, articleListService, articleEditService, articleAddService,articleDeleteService } from '@/api/article.js'
...
const addArticle = async (state) => {
    ...
    try {
        if (articleModel.value.id) {
            let res = await articleEditService(articleModel.value)
    ...
    <el-card class="page-container">
        <template #header>
            <div class="header">
                <span>文章管理</span>
                <div class="extra">
                    <el-button type="primary" @click="visibleDrawer = true; clearData()">添加文章</el-button>
                </div>
            </div>
        </template>
        <!-- 搜索表单 -->
        ...
        <el-drawer v-model="visibleDrawer" title="添加文章" direction="rtl" size="50%">
            ...
            <el-form :model="articleModel" label-width="100px">
                ...
                <el-form-item label="文章封面">
                    ...
                    -->
                    <el-upload class="avatar-uploader" :auto-upload="true" action="/api/upload" name="file"
